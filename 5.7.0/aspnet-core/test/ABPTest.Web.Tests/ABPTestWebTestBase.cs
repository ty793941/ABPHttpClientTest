...
{
    public abstract class ABPTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ABPTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABPTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ABPTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ABPTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ABPTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ABPTestDbContext, Task<T>> func)
        {
            T result;
