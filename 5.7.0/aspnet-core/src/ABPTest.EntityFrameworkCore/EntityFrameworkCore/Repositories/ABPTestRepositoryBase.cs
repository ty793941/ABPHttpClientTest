...
namespace ABPTest.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class ABPTestRepositoryBase<TEntity> : ABPTestRepositoryBase<TEntity, int>, IRepository<TEntity>
